...
- Node.js 18+
- npm или yarn
- Supabase аккаунт (бесплатный) - **опционально для demo режима**

> 💡 **Проект может работать без настройки Supabase в DEMO режиме!**
> См. [DEMO_MODE.md](./DEMO_MODE.md) для подробностей
